...
### Dashboard
![Dashboard](snapshots/DashboardPage.png)

### Projects & Sub-Projects
![Projects Page](snapshots/ProjectsPage.png)

### Upload Test Results
![Upload Test Results](snapshots/UploadTestResultsPage.png)

### Compare Test Runs
![Comparison — Summary & Executive](snapshots/CompareResults_1.png)
![Comparison — Metrics & Insights](snapshots/CompareResults_2.png)
![Comparison — Transaction Table](snapshots/CompareResults_3.png)

### Trend Analysis
![Trend Analysis](snapshots/TrendAnalysis.png)

### PDF Report
![PDF Report](snapshots/CompareResults_PDF_Report.png)
